clearvars ;clc;
Filename = ('Met data_Ponmudi.xlsx');
A = readtable(Filename);
Filename = ('BC_Data_Ponmudi.xlsx');
...
[wint,~] = find(( A.Mon(a) == 12)|(A.Mon(a) == 1)|(A.Mon(a) == 2));
pp = a(wint);
x1 = A.WindDirection(pp);
y1= A.WindSpeed(pp);
[win1,~] = find(( B.Mon == 12)|(B.Mon == 1)|(B.Mon == 2));
z1 = B.conc_6_(win1);
figure
[h,c] = ScatterWindRose(x1,y1,z1);
